    ...
    <html lang="en">
      ...
      <body className="__variable_5cfdac __variable_9a8899 antialiased">
        ...
        <nav className="bg-white border-gray-200 dark:bg-gray-900">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4 ">
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 mx-auto " id="navbar-cta">
                    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-50 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <a href="#aboutme" className="block py-2 px-3 md:p-0 text-white bg-blue-700 rounded-sm md:bg-transparent md:text-blue-700 md:dark:text-blue-500" aria-current="page">About</a>
                        </li>
                        <li>
                            <a href="#skills" className="block py-2 px-3 md:p-0 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Skills</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#contactme" className="block py-2 px-3 md:p-0 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Contact</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <article className="bg-white text-black p-10">
            ...
            {/* About Me */}
            <section id="aboutme" className=" space-y-6 max-w-8xl mx-auto my-10 ">
                ...
                <div className="flex flex-col items-center bg-white  md:flex-row md:max-w-6xl mx-auto gap-5">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col  sm:justify-start sm:space-y-0 gap-3">
                            ...
                            <div>
                                <button type="button" className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"><a href="CV ATS - Valentio Stanley Gunadi.pdf" download>Curriculum Vitae </a></button>
                ...
                <div className="flex max-sm:flex-col md:gap-20 justify-center md:flex-row md:max-w-6xl mx-auto ">
                    <div >
            ...
            <section id="skills" className="bg-white">
                ...
                <div className="flex items-center justify-center ">
                    <div className="bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 w-7xl mt-10 mb-10">
                        ...
                        <ul className="hidden text-sm font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg sm:flex dark:divide-gray-600 dark:text-gray-400 rtl:divide-x-reverse" id="fullWidthTab" data-tabs-toggle="#fullWidthTabContent" role="tablist">
                            ...
                            <li className="w-full">
                                <button id="backend-tab" data-tabs-target="#backend" type="button" role="tab" aria-controls="backend" aria-selected="false" className="inline-block w-full p-4 rounded-se-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600">Back-End</button>
                            </li>
                            <li className="w-full">
                                <button id="data-tab" data-tabs-target="#data" type="button" role="tab" aria-controls="data" aria-selected="false" className="inline-block w-full p-4 rounded-se-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600">Data</button>
                            </li>
                            <li className="w-full">
                                <button id="art-tab" data-tabs-target="#art" type="button" role="tab" aria-controls="art" aria-selected="false" className="inline-block w-full p-4 rounded-se-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600">Art</button>
                            </li>
                            <li className="w-full">
                        ...
                        <div id="fullWidthTabContent" className="border-t border-gray-200 dark:border-gray-600">
                            <div className="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800 gap-5 flex md:flex-row" id="programming" role="tabpanel" aria-labelledby="programming-tab">
                            ...
                            <div className="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="frontend" role="tabpanel" aria-labelledby="frontend-tab">
                                <img width="64" height="32" src="https://img.icons8.com/?size=100&id=MWiBjkuHeMVq&format=png&color=000000" alt="nextjs"/>
                            </div>
                            <div className="hidden p-4 bg-white rounded-lg dark:bg-gray-800 gap-5 flex md:flex-row" id="backend" role="tabpanel" aria-labelledby="backend-tab">
                                <img width="64" height="32" src="https://img.icons8.com/?size=100&id=IrYuykLoqOH6&format=png&color=00ADD8" alt="golang"/>
                            ...
                            <div className="hidden p-4 bg-white rounded-lg dark:bg-gray-800 gap-5 flex md:flex-row" id="data" role="tabpanel" aria-labelledby="data-tab">
                            ...
                            <div className="hidden p-4 bg-white rounded-lg dark:bg-gray-800 gap-5 flex md:flex-row" id="art" role="tabpanel" aria-labelledby="art-tab">
                            ...
                            <div className="hidden p-4 bg-white rounded-lg dark:bg-gray-800 gap-5 flex md:flex-row" id="others" role="tabpanel" aria-labelledby="others-tab">
            ...
            <section id="projects" className="bg-white">
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 w-7xl m-10 justify-center mx-auto">
                    <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 rounded-t-lg bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800 justify-evenly" id="defaultTab" data-tabs-toggle="#defaultTabContent" role="tablist">
                        <li class="me-2">
                            <button id="about-tab" data-tabs-target="#about" type="button" role="tab" aria-controls="about" aria-selected="true" class="inline-block p-4 text-blue-600 dark:bg-gray-800 dark:text-blue-500">Tech</button>
                        </li>
                        <li class="me-2">
                            <button id="services-tab" data-tabs-target="#services" type="button" role="tab" aria-controls="services" aria-selected="false" class="inline-block p-4 hover:text-gray-600  dark:hover:text-gray-300">Art</button>
                        </li>
                        <li class="me-2">
                            <button id="statistics-tab" data-tabs-target="#statistics" type="button" role="tab" aria-controls="statistics" aria-selected="false" class="inline-block p-4 hover:text-gray-600  dark:hover:text-gray-300">F&B</button>
                        </li>
                    </ul>
                    <div id="defaultTabContent">
                        <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800 flex gap-5 max-sm:flex-col" id="about" role="tabpanel" aria-labelledby="about-tab">
                        ...
                        <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800 flex gap-5 max-sm:flex-col" id="services" role="tabpanel" aria-labelledby="services-tab">
                            <a href="#" class="block max-w-sm p-3 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"><Image src="/EmotRec-Web.png" alt="project-tech" width={400} height={200} />
                            <h3 className="font-semibold text-center mt-3">Emotion Recognition Web App</h3>
                            </a>
                        ...
                        <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800 flex gap-5 max-sm:flex-col" id="statistics" role="tabpanel" aria-labelledby="statistics-tab">
                            <a href="#" class="block max-w-sm p-3 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"><Image src="/EmotRec-Web.png" alt="project-tech" width={400} height={200} />
                            <h3 className="font-semibold text-center mt-3">Emotion Recognition Web App</h3>
                            </a>
            ...
            <section id="contactme" className="flex max-sm:flex-col w-full max-w-4xl p-4 border border-gray-200 rounded-lg shadow-sm sm:p-6 md:p-8  mx-auto justify-center gap-10">
                <div className="">
                    <div className="flex items-start gap-2.5 mx-auto">
                        ...
                        <div className="flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
                            <div className="flex items-center space-x-2 rtl:space-x-reverse">
                                ...
                                <span className="text-sm font-normal text-gray-500 dark:text-gray-400">{currentTime.toLocaleTimeString()}</span>
                                <time id="current-time"></time>
                            </div>
                            <p className="text-sm font-normal py-2.5 text-gray-900 dark:text-white">Oh, are you interested in me? Just leave a message here, okay?</p>
                        </div>
                    </div>
